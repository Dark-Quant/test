...
import ru.quantumemperor.testmod.item.inventory.ImplementedInventory;
import ru.quantumemperor.testmod.screen.MythrilBlasterScreenHandler;
...
public class MythrilBlasterBlockEntity extends BlockEntity implements NamedScreenHandlerFactory, ImplementedInventory {
    ...
    private static void craftItem(MythrilBlasterBlockEntity entity) {
        ...
        entity.setStack(3, new ItemStack(Items.NETHERITE_PICKAXE,
